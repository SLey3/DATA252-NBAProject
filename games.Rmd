...
library(caret)
poly_model <- lm(data = teams_winners, formula = point_diff ~ poly(assists,3))
#MAKE A GRAPHIC!
...
another_model = lm(data = teams_winners, formula = fieldGoalsPercentage ~ assists)
...
rmodel_comparison <- data.frame(
  ...
  RMSE_CV = c(5.9147, 6.0474, 6.1232, 6.4246,
