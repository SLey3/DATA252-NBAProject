...
setwd("/Users/sergioleylanguren/Desktop/DATA252/DATA252-NBAProject") # or wherever your project path is located at
...
caretTree  <-  train(point_diff ~  conference+
    division+
    fieldGoalsPercentage+
    threePointersPercentage+
    freeThrowsPercentage+
    ...
    reboundsTotal, 
                    ...
                    method = "rpart",
                    trControl=trctrl,
                    tuneGrid = expand.grid(cp=seq(0.009, 0.1, 0.009))
)
